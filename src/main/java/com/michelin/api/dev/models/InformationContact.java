...
/**
 * This is a model class for InformationContact type.
 */
public class InformationContact {
    ...
    /**
     * Converts this InformationContact into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "InformationContact [" + "contactID=" + contactID + ", name=" + name
    ...
    /**
     * Builds a new {@link InformationContact.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link InformationContact.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link InformationContact}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link InformationContact} object using the set fields.
         * @return {@link InformationContact}
         */
        public InformationContact build() {
            return new InformationContact(contactID, name, telephoneNumber, telephoneExtension,
