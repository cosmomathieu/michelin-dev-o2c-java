...
/**
 * This is a model class for Consignee5 type.
 */
public class Consignee5 {
     ...
     * @param  address  Address12 value for address.
    ...
    /**
     * Setter for Address.
     * @param address Value for Address12
     */
    @JsonSetter("Address")
    ...
    /**
     * Converts this Consignee5 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Consignee5 [" + "partyID=" + partyID + ", agencyCode=" + agencyCode + ", name="
                + name + ", address=" + address + ", informationContact=" + informationContact
                + "]";
    }

    /**
     * Builds a new {@link Consignee5.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Consignee5.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Consignee5}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder address(Address12 address) {
            this.address = address;
            return this;
        }
        ...
        /**
         * Builds a new {@link Consignee5} object using the set fields.
         * @return {@link Consignee5}
         */
        public Consignee5 build() {
            return new Consignee5(partyID, agencyCode, name, address, informationContact);
        }
    }
}
