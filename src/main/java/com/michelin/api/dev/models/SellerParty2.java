...
/**
 * This is a model class for SellerParty2 type.
 */
public class SellerParty2 {
    ...
    /**
     * Converts this SellerParty2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SellerParty2 [" + "partyID=" + partyID + ", agencyCode=" + agencyCode + ", name="
                + name + ", address=" + address + ", informationContact=" + informationContact
                + "]";
    }

    /**
     * Builds a new {@link SellerParty2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SellerParty2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SellerParty2}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SellerParty2} object using the set fields.
         * @return {@link SellerParty2}
         */
        public SellerParty2 build() {
            return new SellerParty2(partyID, agencyCode, name, address, informationContact);
        }
    }
}
