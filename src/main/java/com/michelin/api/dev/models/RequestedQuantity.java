...
/**
 * This is a model class for RequestedQuantity type.
 */
public class RequestedQuantity {
    ...
    /**
     * Converts this RequestedQuantity into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RequestedQuantity [" + "quantityValue=" + quantityValue + "]";
    }

    /**
     * Builds a new {@link RequestedQuantity.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RequestedQuantity.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RequestedQuantity}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RequestedQuantity} object using the set fields.
         * @return {@link RequestedQuantity}
         */
        public RequestedQuantity build() {
            return new RequestedQuantity(quantityValue);
        }
    }
}
