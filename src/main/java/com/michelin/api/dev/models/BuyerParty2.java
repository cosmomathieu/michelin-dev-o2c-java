...
/**
 * This is a model class for BuyerParty2 type.
 */
public class BuyerParty2 {
    ...
    /**
     * Converts this BuyerParty2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BuyerParty2 [" + "partyID=" + partyID + ", agencyCode=" + agencyCode + ", name="
                + name + ", address=" + address + ", informationContact=" + informationContact
                + "]";
    }

    /**
     * Builds a new {@link BuyerParty2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BuyerParty2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BuyerParty2}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BuyerParty2} object using the set fields.
         * @return {@link BuyerParty2}
         */
        public BuyerParty2 build() {
            return new BuyerParty2(partyID, agencyCode, name, address, informationContact);
        }
    }
}
