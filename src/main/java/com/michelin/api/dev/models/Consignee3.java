...
/**
 * This is a model class for Consignee3 type.
 */
public class Consignee3 {
     ...
     * @param  address  Address5 value for address.
    ...
    /**
     * Setter for Address.
     * @param address Value for Address5
     */
    @JsonSetter("Address")
    ...
    /**
     * Converts this Consignee3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Consignee3 [" + "partyID=" + partyID + ", agencyCode=" + agencyCode + ", name="
                + name + ", address=" + address + ", informationContact=" + informationContact
                + "]";
    }

    /**
     * Builds a new {@link Consignee3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Consignee3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Consignee3}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder address(Address5 address) {
            this.address = address;
            return this;
        }
        ...
        /**
         * Builds a new {@link Consignee3} object using the set fields.
         * @return {@link Consignee3}
         */
        public Consignee3 build() {
            return new Consignee3(partyID, agencyCode, name, address, informationContact);
        }
    }
}
