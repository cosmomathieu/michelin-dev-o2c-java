...
/**
 * This is a model class for WarrantyNumber type.
 */
public class WarrantyNumber {
    ...
    /**
     * Converts this WarrantyNumber into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WarrantyNumber [" + "documentID=" + documentID + ", lineID=" + lineID
                + ", issueDate=" + issueDate + "]";
    }

    /**
     * Builds a new {@link WarrantyNumber.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WarrantyNumber.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WarrantyNumber}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link WarrantyNumber} object using the set fields.
         * @return {@link WarrantyNumber}
         */
        public WarrantyNumber build() {
            return new WarrantyNumber(documentID, lineID, issueDate);
        }
    }
}
