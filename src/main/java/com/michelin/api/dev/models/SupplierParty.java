...
/**
 * This is a model class for SupplierParty type.
 */
public class SupplierParty {
    ...
    /**
     * Converts this SupplierParty into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SupplierParty [" + "partyID=" + partyID + ", agencyCode=" + agencyCode + "]";
    }

    /**
     * Builds a new {@link SupplierParty.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SupplierParty.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SupplierParty}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SupplierParty} object using the set fields.
         * @return {@link SupplierParty}
         */
        public SupplierParty build() {
            return new SupplierParty(partyID, agencyCode);
        }
    }
}
